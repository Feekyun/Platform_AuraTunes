...
import com.example.test_platform.adapters.tracks_adapter
...
class album_tracks : Fragment(), tracks_adapter.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        download.setOnClickListener {
            val toast = Toast.makeText(
                requireContext(),
                "Download feature is only for Premium users",
                Toast.LENGTH_LONG
            )
            toast.show()
        }
        ...
        shuffle.setOnClickListener {
            val toast =
                Toast.makeText(requireContext(), "Album Already in order", Toast.LENGTH_SHORT)
            toast.show()
        }
    ...
    private fun showDialog() {
        ...
        download.setOnClickListener {
            val toast =
                Toast.makeText(requireContext(), "Only for Premium users", Toast.LENGTH_SHORT)
            toast.show()
            dialog.hide()
        }
        ...
        share.setOnClickListener {
            val shareIntent = Intent(Intent.ACTION_SEND).apply {
                ...
                putExtra(
                    Intent.EXTRA_TEXT,
                    "Check out Soundify App at: https://play.google.com/store/apps/details?id=soundify.rockbuilds"
                )
            }
